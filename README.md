...
- VS Code 대체 에디터
    1. VsCodium - https://vscodium.com/
        - 서브로 쓸 것 나눠서 VsCodium에 다운로드 받아 사용하기
    2. cursor Ai - https://cursor.com/
        - 코드 짜는데 유용한 Ai
        - 바이브 코딩용
- VS Code와 동일한 기능 제공 (둘다 VS Code 커스터마이징함)
- VS Code에 MCP 플러그인 설치해도 Cursor AI와 동일하게 사용가능
- 메인 VS Code, 서브로 Cursor나 VS Codium 사용 추천
...
### 코딩테스트 사이트
- 프로그래머스 - http://school.programmrs.co.kr/
    - 카카오가 가장 많이 사용하는 코테 사이트
    - 기업 블라인드 테스트에 많이 사용
    - 바로 소스코드를 실행하면서 코테 가능
    - 프로그래머스 인증시험도 채용시 활용(PCCP, PCSQL)
- 백준 - http://www.acmicpc.net/
    - 가장 유명한 코테 사이트
    - 평가가 불편, 소스코드를 올려서 점수를 확인하는 스타일
    - 커뮤니티가 다양
...
- `자동완성 기능` 없음! VS Code에 익숙한 사람은 프로그램머스에서 연습을 더 해야함

##### 프로그래머스 사용법
1. http://school.programmrs.co.kr/ 진입
2. 회원가입(생략)
3. 로그인 후 코딩테스트 메뉴
4. 스킬체크 시작
